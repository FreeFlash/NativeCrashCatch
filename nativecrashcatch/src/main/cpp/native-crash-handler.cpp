...
JNIEXPORT jboolean
JNICALL
Java_com_flash_nativecatch_NativeHandler_createNativeException(JNIEnv *env, jobject) {
...
JNIEXPORT void
JNICALL
Java_com_flash_nativecatch_NativeHandler_initNativeHandler(JNIEnv *zenv, jobject thiz, int pid) {
    sigEnv = zenv;
